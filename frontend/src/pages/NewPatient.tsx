...
const NewPatient: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Navigate to patients list or patient detail
      navigate('/patients', { 
        state: { 
  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <p className="mt-2 text-gray-600">Add a new patient to your practice</p>
      </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          {currentStep === 1 && (
            <div className="space-y-6">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  DNI (Peruvian ID) <span className="text-red-500">*</span>
                </label>
                <input
                  type="text"
                  value={formData.dni}
                  ...
                  maxLength={8}
                />
                <p className="mt-1 text-xs text-gray-500">Must be 8 digits</p>
                {errors.dni && (
          ...
          {currentStep === 2 && (
            <div className="space-y-6">
              <div className="mb-6">
                ...
                <p className="text-sm text-gray-600">All fields in this section are optional</p>
              </div>
